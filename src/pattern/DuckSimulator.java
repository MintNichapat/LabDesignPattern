package pattern.adapters;

import pattern.animals.*;
import pattern.animals.composites.Flock;
import pattern.animals.composites.LeaderFlock;
import pattern.animals.decorated.QuackCounter;
import pattern.factories.AbstractDuckFactory;
import pattern.factories.CountAndEchoDuckFactory;
import pattern.factories.CountingDuckFactory;
import pattern.factories.DuckFactory;
